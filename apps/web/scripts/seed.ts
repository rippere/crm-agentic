...
async function seed() {
  ...
  const agents = [
    {
      ...
      model: "Sentence-transformer embeddings", tasks_today: 312, last_run: "2 min ago",
    ...
    },
    {
      ...
      description: "Scores every contact 0–100 from engagement signals and contact embeddings. Re-scores as new behavioral activity comes in.",
      model: "Embedding + engagement scoring", tasks_today: 524, last_run: "8 min ago",
      metrics: [{ label: "Scores Updated", value: "524", delta: "+112" }, { label: "Hot Leads", value: "23", delta: "+5" }, { label: "Avg Score", value: "67" }],
      workflow: [
        { id: "w1", label: "Behavior Event", type: "trigger", position: { x: 0, y: 0 } },
        { id: "w2", label: "Embed Signals", type: "action", position: { x: 200, y: 0 }, connected: ["w1"] },
        { id: "w3", label: "Score Lead", type: "action", position: { x: 400, y: 0 }, connected: ["w2"] },
    ...
    },
    {
      ...
      description: "Drafts personalized outreach emails using contact context, semantic tags, and deal stage. Adapts tone to role and industry.",
      model: "Claude (Haiku)", tasks_today: 87, last_run: "Just now",
      metrics: [{ label: "Emails Drafted", value: "87", delta: "+22" }, { label: "Awaiting Review", value: "12" }, { label: "Sent Today", value: "63" }],
      workflow: [
        ...
        { id: "w3", label: "Draft with Claude", type: "action", position: { x: 400, y: 0 }, connected: ["w2"] },
    ...
    },
    {
      ...
      model: "Whisper + Claude (Sonnet)", tasks_today: 14, last_run: "1 hour ago",
    ...
    },
    {
      ...
      description: "Monitors deal velocity and flags stalls. Recommends next best actions from stage history and engagement patterns.",
      model: "Deal velocity heuristics", tasks_today: 201, last_run: "15 min ago",
      metrics: [{ label: "Stalls Detected", value: "7", delta: "+2" }, { label: "Actions Recommended", value: "201" }, { label: "Deals Monitored", value: "148" }],
      workflow: [
    ...
    },
    {
      ...
      model: "Claude (Haiku)", tasks_today: 388, last_run: "5 min ago",
      ...
      workflow: [
        ...
        { id: "w2", label: "Analyze with Claude", type: "action", position: { x: 200, y: 0 }, connected: ["w1"] },
  ...
  const activity = [
    ...
    { workspace_id: workspaceId, type: "model_updated", agent_name: "Lead Scorer", description: "Re-scored 1,204 contacts on new activity", meta: "Hot: 23 · Warm: 61 · Cold: 38", severity: "success" },
  ];
