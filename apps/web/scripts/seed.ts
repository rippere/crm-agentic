...
// ─── Deals ───────────────────────────────────────────────────
const deals = [
  { title: "NexLabs Enterprise Suite", company: "NexLabs", contact_name: "Sarah Chen", value: 48000, stage: "negotiation", ml_win_probability: 87, expected_close: "Apr 30, 2026", assigned_agent: "Pipeline Optimizer", notes: "Legal review in progress. Champion confirmed budget." },
  { title: "StrataForm Pilot", company: "StrataForm", contact_name: "Marcus Webb", value: 12000, stage: "proposal", ml_win_probability: 62, expected_close: "May 15, 2026", assigned_agent: "Email Composer", notes: "Proposal sent. Awaiting feedback from board." },
  { title: "Meridian Capital Renewal", company: "Meridian Capital", contact_name: "James Okafor", value: 120000, stage: "qualified", ml_win_probability: 91, expected_close: "Jun 1, 2026", assigned_agent: "Lead Scorer", notes: "Annual renewal. Expansion to 5 more seats discussed." },
  { title: "Axion Systems Upsell", company: "Axion Systems", contact_name: "Dmitri Volkov", value: 65000, stage: "discovery", ml_win_probability: 74, expected_close: "May 30, 2026", assigned_agent: "Semantic Sorter", notes: "Interested in analytics add-on module." },
  { title: "CloudVault AI Starter", company: "CloudVault AI", contact_name: "Priya Nair", value: 8400, stage: "discovery", ml_win_probability: 45, expected_close: "Jun 20, 2026", assigned_agent: "Sentiment Analyzer", notes: "Early stage. Needs more qualification." },
  { title: "Solvio EU Enterprise", company: "Solvio EU", contact_name: "Lena Kovacs", value: 30000, stage: "closed_lost", ml_win_probability: 0, expected_close: "Mar 31, 2026", assigned_agent: "Pipeline Optimizer", notes: "Lost to competitor. Price was the primary objection." },
  { title: "NexLabs Analytics Module", company: "NexLabs", contact_name: "Sarah Chen", value: 18000, stage: "closed_won", ml_win_probability: 100, expected_close: "Apr 5, 2026", assigned_agent: "Pipeline Optimizer", notes: "Signed. Onboarding scheduled for Apr 12." },
];
...
// ─── Activity Events ─────────────────────────────────────────
const activity = [
  { type: "contact_scored", agent_name: "Lead Scorer", description: "Re-scored Dmitri Volkov → 95 (was 88)", meta: "Upsell signals detected", severity: "success" },
  { type: "tag_applied", agent_name: "Semantic Sorter", description: "Tagged 12 new contacts with 'Enterprise Buyer'", meta: "Avg confidence: 93.4%", severity: "info" },
  { type: "email_sent", agent_name: "Email Composer", description: "Drafted follow-up for Marcus Webb", meta: "Proposal stage · Human review pending", severity: "info" },
  { type: "deal_moved", agent_name: "Pipeline Optimizer", description: "NexLabs Enterprise Suite → Negotiation", meta: "Win probability: 87%", severity: "success" },
  { type: "agent_run", agent_name: "Sentiment Analyzer", description: "Flagged Lena Kovacs as at-risk", meta: "Sentiment score dropped to 0.31", severity: "warning" },
  { type: "call_summarized", agent_name: "Call Summarizer", description: "Processed 38-min call with James Okafor", meta: "3 action items extracted", severity: "info" },
  { type: "model_updated", agent_name: "Lead Scorer", description: "XGBoost model retrained on 1,204 new samples", meta: "F1: 0.947 → 0.951 (+0.4%)", severity: "success" },
];
