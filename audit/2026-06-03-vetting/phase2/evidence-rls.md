...
Output:
```
DATABASE_URL=postgresql+asyncpg://postgres.ilfibxflnelssllgszex:HIcBXgSJLHYcy85U@aws-1-us-west-2.pooler.supabase.com:5432/postgres
```
Connection string used for psql (stripped `+asyncpg`):
```
postgresql://postgres.ilfibxflnelssllgszex:HIcBXgSJLHYcy85U@aws-1-us-west-2.pooler.supabase.com:5432/postgres
```
